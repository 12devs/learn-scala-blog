UPDATE components SET component_name = 'BCT Chat' WHERE component_id = 'bct-chat';
UPDATE components SET component_name = 'CryptoMarketCap Info' WHERE component_id = 'cryptomarketcap-info';
UPDATE components SET component_name = 'Spreadsheets' WHERE component_id = 'spreadsheets';
...
UPDATE components SET component_name = 'Heatmap Unusual volume'  WHERE component_id = 'heatmap-unusual-volume';