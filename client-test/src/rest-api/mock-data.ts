...
export const articlesMockData: ArticleEntity[] = [
    {
        id: 1,
    ...
    },
    {
        ...
        mainText: "The US has said it will not be easing sanctions until North Korea has denuclearised - despite claims made by Pyongyang state media.\n" +
        "\n" +
    ...
    {
        id: 3,
        title: "Apple to block popular police method for breaking into iPhones",
        mainText: "Apple has said it will change iPhone settings to block a method used by police and intelligence agencies to break into devices.\n" +
        "\n" +
        ...
        "Apple began working on the USB issue before learning it was popularly used by police\n" +
